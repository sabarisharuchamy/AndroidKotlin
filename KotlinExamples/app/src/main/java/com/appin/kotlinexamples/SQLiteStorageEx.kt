...
import kotlinx.android.synthetic.main.activity_sqlite_storage_ex.*

class SQLiteStorageEx : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_sqlite_storage_ex)
    }
