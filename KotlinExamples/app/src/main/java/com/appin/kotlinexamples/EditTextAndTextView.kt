...
import kotlinx.android.synthetic.main.activity_edit_text_and_text_view.*

class EditTextAndTextView : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_edit_text_and_text_view)
